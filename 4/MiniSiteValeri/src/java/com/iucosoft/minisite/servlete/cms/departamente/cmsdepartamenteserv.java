 ...
 * @author iucosoftmain
 */
public class cmsdepartamenteserv extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            List<Departament> lista = depDao.findAll();
        ...
        request.getRequestDispatcher("/WEB-INF/cms/departamente/cmsdepartamente.jsp").forward(request, response);
